...
use common\models\User2Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use Yii;
/**
 * ConfigController implements the CRUD actions for User2 model.
 */
class ConfigController extends Controller
{
    ...
    {
        if (($model = User2::findOne(['id' => $id])) !== null) {
            return $model;
        }
